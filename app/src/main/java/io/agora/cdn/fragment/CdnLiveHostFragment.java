...
import io.agora.cdn.presenter.CdnHostPresenter;
import io.agora.cdn.presenter.ICdnHostView;
...
public class CdnLiveHostFragment extends CdnLiveBaseFragment implements ICdnHostView, IDirectCdnStreamingEventHandler {
    ...
    public CdnLiveHostFragment(CdnHostPresenter presenter) {
    ...
    private void getCdnUrl(String token) {
        presenter.getCdnUrl(token);
    }
    ...
    public void onLeaveChannel() {
        preLeave = true;
        helper.stopDirectCDNStreaming(null);
    ...
    private void startBroadcast() {
        isRoomReady = false;
        isTokenReady = false;
        helper.startCdnBroadcast(mVideoGridContainer, uid, cdnUrl, this);
    }

    public void setPresenter(CdnHostPresenter presenter) {
        this.presenter = presenter;
