package io.agora.livedemo.ui.fast;
...
import io.agora.livedemo.ui.fast.presenter.FastLiveHostPresenterImpl;
...
public class FastLiveHostActivity extends LiveBaseActivity implements LiveAnchorFragment.OnCameraListener, OnConfirmClickListener {
    ...
    public void onRoomOwnerChangedToOtherUser(String chatRoomId, String newOwner) {
        EMLog.d(TAG, "onRoomOwnerChangedToOtherUser newOwner: " + newOwner + " current user: " + ChatClient.getInstance().getCurrentUser());
        if (presenter != null) {
