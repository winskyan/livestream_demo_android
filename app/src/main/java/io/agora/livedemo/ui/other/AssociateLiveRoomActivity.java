...
//                return LiveManager.getInstance().getAssociatedRooms(ChatClient.getInstance().getCurrentUser());
//            }
//
...
//                        currentLiveRoom.getOwner().equals(ChatClient.getInstance().getCurrentUser())){
//                    startActivity(new Intent(AssociateLiveRoomActivity.this, LiveAnchorActivity.class)
